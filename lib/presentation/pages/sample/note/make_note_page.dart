...
class MakeNotePage extends StatefulWidget {
  ...
  @override
  MakeNotePageState createState() => MakeNotePageState();
}

class MakeNotePageState extends State<MakeNotePage> with SingleTickerProviderStateMixin{
  //ぺインター設定
                                  ...
                                  children: <Widget>[
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        folderList.add(noteNameText);
                                        folderBox.put("Folder", folderList);
                                        //画像エンコード
