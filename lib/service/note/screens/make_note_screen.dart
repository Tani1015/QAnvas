...
class MakeNoteScreen extends StatefulHookConsumerWidget {
  ...
  @override
  MakeNoteState createState() => MakeNoteState();
}

class MakeNoteState extends ConsumerState<MakeNoteScreen> with SingleTickerProviderStateMixin{
  //ぺインター設定
  ...
  Widget build(BuildContext context) {
    ...
    //Hive.box("Folder")のindex
    final folderIndex = widget.index;
